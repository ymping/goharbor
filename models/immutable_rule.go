...
func (m *ImmutableRule) contextValidateScopeSelectors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ImmutableRule) contextValidateTagSelectors(ctx context.Context, formats strfmt.Registry) error {
