...
type ClientService interface {
	...
	GetScannerOfProject(params *GetScannerOfProjectParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetScannerOfProjectOK, error)
	...
	ListScannerCandidatesOfProject(params *ListScannerCandidatesOfProjectParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ListScannerCandidatesOfProjectOK, error)

	SetScannerOfProject(params *SetScannerOfProjectParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*SetScannerOfProjectOK, error)
...
*/
func (a *Client) GetScannerOfProject(params *GetScannerOfProjectParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetScannerOfProjectOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) ListScannerCandidatesOfProject(params *ListScannerCandidatesOfProjectParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ListScannerCandidatesOfProjectOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) SetScannerOfProject(params *SetScannerOfProjectParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*SetScannerOfProjectOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
