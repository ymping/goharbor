...
type ClientService interface {
	...
	GetRegistryInfo(params *GetRegistryInfoParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetRegistryInfoOK, error)
	...
	ListRegistryProviderInfos(params *ListRegistryProviderInfosParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ListRegistryProviderInfosOK, error)

	ListRegistryProviderTypes(params *ListRegistryProviderTypesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ListRegistryProviderTypesOK, error)

	PingRegistry(params *PingRegistryParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*PingRegistryOK, error)
...
*/
func (a *Client) GetRegistryInfo(params *GetRegistryInfoParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetRegistryInfoOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) ListRegistryProviderInfos(params *ListRegistryProviderInfosParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ListRegistryProviderInfosOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) ListRegistryProviderTypes(params *ListRegistryProviderTypesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ListRegistryProviderTypesOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) PingRegistry(params *PingRegistryParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*PingRegistryOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
