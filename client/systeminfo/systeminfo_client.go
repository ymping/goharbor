...
type ClientService interface {
	GetCert(params *GetCertParams, authInfo runtime.ClientAuthInfoWriter, writer io.Writer, opts ...ClientOption) (*GetCertOK, error)

	GetSystemInfo(params *GetSystemInfoParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetSystemInfoOK, error)

	GetVolumes(params *GetVolumesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetVolumesOK, error)
...
*/
func (a *Client) GetCert(params *GetCertParams, authInfo runtime.ClientAuthInfoWriter, writer io.Writer, opts ...ClientOption) (*GetCertOK, error) {
...
*/
func (a *Client) GetVolumes(params *GetVolumesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetVolumesOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
