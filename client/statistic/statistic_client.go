...
type ClientService interface {
	GetStatistic(params *GetStatisticParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetStatisticOK, error)
...
*/
func (a *Client) GetStatistic(params *GetStatisticParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetStatisticOK, error) {
	...
	success, ok := result.(*GetStatisticOK)
	if ok {
		return success, nil
	}
