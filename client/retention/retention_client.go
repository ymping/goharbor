...
type ClientService interface {
	...
	DeleteRetention(params *DeleteRetentionParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*DeleteRetentionOK, error)
...
*/
func (a *Client) DeleteRetention(params *DeleteRetentionParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*DeleteRetentionOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
