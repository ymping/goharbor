...
type ClientService interface {
	...
	GetCurrentUserInfo(params *GetCurrentUserInfoParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetCurrentUserInfoOK, error)
	...
	SetCliSecret(params *SetCliSecretParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*SetCliSecretOK, error)

	SetUserSysAdmin(params *SetUserSysAdminParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*SetUserSysAdminOK, error)
...
*/
func (a *Client) GetCurrentUserInfo(params *GetCurrentUserInfoParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetCurrentUserInfoOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) SetCliSecret(params *SetCliSecretParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*SetCliSecretOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) SetUserSysAdmin(params *SetUserSysAdminParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*SetUserSysAdminOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
